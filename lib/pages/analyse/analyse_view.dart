...
import 'package:moodiary/components/mood_chart/mood_chart_view.dart';
        ...
        builder: (_) {
          return ListView(
            ...
            children: [
              ...
              if (PrefUtil.getValue<bool>('moodTrendChart') ?? true) ...[
                MoodStatistics(moodValues: state.moodList),
                ...
                Card.filled(
                  ...
                  child: Padding(
                    ...
                    child: MoodTrendChart(
                      moodValues: state.moodList,
                      dates: state.dateList,
                      width: size.width - 32,
                      height: 200,
                    ),
                  ),
