...
import 'package:moodiary/components/mood_palette/mood_palette_view.dart';
              ...
              children: [
                ...
                Expanded(
                  child: Slider(
                    ...
                    activeColor: AppColor.getEmotionColor(
                ...
                if (PrefUtil.getValue<bool>('aiMoodRecommend') ?? true)
                  GetBuilder<EditLogic>(
                    id: 'AiMood',
                    builder: (_) {
                      return IconButton(
                        onPressed: state.loadingAiMood
                            ? null
                            : () {
                                logic.aiRecommendMood(context);
                              },
                        icon: state.loadingAiMood
                            ? const SizedBox(
                                width: 20,
                                height: 20,
