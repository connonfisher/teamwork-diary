...
class PrefUtil {
  ...
  static Future<void> setDefaultValues() async {
    ...
    await _prefs.setInt('color', _prefs.getInt('color') ?? 1);
    ...
    await _prefs.setBool(
      'moodPaletteEnabled',
      _prefs.getBool('moodPaletteEnabled') ?? true,
    );
    await _prefs.setInt(
      'moodPaletteStyle',
      _prefs.getInt('moodPaletteStyle') ?? 0,
    );
    await _prefs.setStringList(
      'customEmotions',
      _prefs.getStringList('customEmotions') ?? [],
    );
    await _prefs.setBool(
      'aiMoodRecommend',
      _prefs.getBool('aiMoodRecommend') ?? true,
    );
    await _prefs.setBool(
      'moodTrendChart',
